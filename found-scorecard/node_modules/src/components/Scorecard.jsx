...
function IntroScreen({ onStart }) {
  const testimonials = [
    { name: 'Samantha M.', role: 'Principal', company: 'The Carlyle Group', quote: 'The use of data and science, combined with her private equity background, made this feel different. Would strongly recommend!', initials: 'SM' },
    { name: 'Harry G.', role: 'Head of Sales & Former GB Athlete', company: 'Arctic Shores', quote: "Emily's guidance pushed me through to new levels of performance I hadn't thought were possible in such a short period of time. I am calmer, more structured, and ultimately much more productive. The ROI is evident.", initials: 'HG' },
    { name: 'Nathalie R.', role: 'Chief Legal Officer', company: 'Santander Corporate & Investment Banking', quote: 'Emily brings her own experience of working in the industry and the insights gained from coaching busy professionals, to provide practical guidance to maximise performance.', initials: 'NR' },
    { name: 'Magnus L.', role: 'Director & Management Team', company: 'PwC', quote: 'Emily has a large toolbox of ideas when you feel trapped in your own disadvantaged behaviours. The skills she possesses not only make her fit as a coach, but she also has great leadership traits.', initials: 'ML' },
    { name: 'Thomas C.', role: 'Private Equity Deal Team', company: 'EQT', quote: 'Outstanding coach — supportive, structured, and impactful. Thank you, Emily!', initials: 'TC' },
  ];
  ...
  return (
    <div id="screen-intro" className="screen active" style={{ textAlign: 'center' }}>
      <div className="intro-hero">
        ...
        <p className="intro-sub">Take the Performance Scorecard and benchmark your ability to perform at work. Instant access to your results.</p>
        ...
        <div className="how-it-works">
          <div className="hiw-content">
            ...
            <ul className="hiw-list">
              ...
              <li><span className="hiw-arrow">→</span><div><strong>Detailed Performance Scores</strong><p>Receive an overall performance score plus individual scores for Mental Performance, Emotional Intelligence, Energy Management, Resilience, Engagement, and Executional.</p></div></li>
        ...
        <div className="results-hero-inner">
          ...
          <div className="results-hero-left">
            ...
            <h2 className="results-thanks">
              {userData.firstName
                ? `Thank you for completing the FOUND Performance Scorecard, ${userData.firstName}.`
                : 'Thank you for completing the FOUND Performance Scorecard.'}
            </h2>
            <p className="results-explainer-text">We've scored your responses across 6 performance dimensions, each out of 100%. Your results reflect how consistently the habits, behaviours and conditions that drive high performance are present in your working life right now.</p>
            <p className="results-explainer-text">Above 80% is high performance. 60–80% is strong. 40–60% is developing. Below 40% signals areas that may be limiting your output.</p>
