...
const dimContent = {
  ...
  pace: {
    what: [
      ...
      'Sustained Pace also requires deliberate recovery. Research on chronic stress and cognitive performance shows that pressure without recovery does not build resilience. It produces gradual degradation. The professionals with the longest and strongest careers manage their energy as deliberately as their time.',
    ],
  ...
  profile: {
    what: [
      ...
      'Research on organisational networks shows that professionals with strong internal visibility are promoted faster and given more consequential work earlier, independent of raw performance. The decisions that shape careers are made in conversations you are never part of. Internal profile determines whether your name comes up.',
    ...
    tips: [
      'Schedule fifteen minutes with one senior person outside your immediate team and use it to ask a genuine question about their work, not to present yours. Research on trust-building shows interest in the other person compounds faster than self-presentation.',
      'Rate yourself honestly on the two dimensions that research shows drive professional influence: warmth and competence. Most professionals in this industry over-index on one at the expense of the other. Identify which, then work on it deliberately.',
      'Block a fixed weekly slot for business development and external relationship activity. Research shows that scheduling a specific time more than doubles follow-through compared to intention alone.',
    ],
  },
  performance: {
    what: [
      ...
      'Research on expert performance is unambiguous: what separates the best is not talent or experience but the quality of deliberate practice. Professionals who perform best in critical moments do not rise to the occasion. They fall to the level of their preparation.',
      'Emotion is also a direct performance variable. Neurological research has shown that emotional processing is not separate from good decision-making. It is part of it. Reframing a difficult situation before the stress response sets in, rather than suppressing it after, produces better decisions and preserves the cognitive resources needed to make them.',
      'Confidence matters too. Research on feedback deprivation shows that capable professionals systematically underestimate their own ability without regular external calibration. Frequent, specific feedback is the fix. As AI takes on more analytical work, judgement becomes the differentiator. That cannot be delegated.',
    ],
    ...
    tips: [
      'Before any important meeting or decision, run a pre-mortem. Assume it has gone badly and work backwards: what went wrong and why? Research shows this surfaces blind spots and failure modes that forward planning misses, and leads to materially better outcomes.',
      'Build a brief pre-performance routine before anything important. Research shows that reframing pressure as opportunity before the stress response sets in, rather than suppressing it after, produces measurably better decisions and clearer thinking.',
  ...
  progress: {
    what: [
      ...
      'Research on career advancement shows that the professionals who progress fastest are not always the strongest technical performers. They are the ones whose contribution is most legible to decision-makers, and who manage that legibility actively rather than assuming it takes care of itself.',
      'The professionals who build the most durable careers eventually become multipliers. They create genuine value for others without depleting themselves, and attract the sponsorship that individual performance alone cannot generate. The leaders who build the strongest teams make honest challenge feel safe rather than costly. That reputation, once established, compounds.',
      'A high score here is a genuine signal of strength. The task now is protecting that momentum and thinking about the kind of leader you want to become, not just the next level you want to reach.',
    ],
    ...
    tips: [
      ...
      'Invest deliberately in one person more junior than you this quarter. Research on leadership shows that being seen to develop others signals readiness for the next level more clearly than almost anything else.',
    ],
  },
};
